  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route exact path="/product/:id" element={<ProductDetails isAuthenticated={isAuthenticated} />}/>
        ...
        {isAuthenticated && isAdmin && <Route exact path="/admin/product/new" element={<NewProduct/>}/>}
        ...
        {isAuthenticated && isAdmin && <Route exact path="/admin/users" element={<UsersList/>}/>}
